...
<section class="tabbed sm--bottom">
	...
	<div id="tab2-tab" class="tabbed--item" data-title="<?php echo $tab2['tab_title']; ?>" tabindex="-1" role="tabpanel" aria-labelledby="tab2">
		<div class="tabbed--item-container">
			<div class="tabbed--item__inner">
				<div class="tabbed--item__content content">
	...
	<div id="tab3-tab" class="tabbed--item" data-title="<?php echo $tab3['tab_title']; ?>" tabindex="-1" role="tabpanel" aria-labelledby="tab3">
		<div class="tabbed--item-container">
			<div class="tabbed--item__inner">
				<div class="tabbed--item__content content">
